                ...
                <div class="card sparkling">
                    ...
                    <div class="content">
                        <div class="buttons">
                            ...
                            {{-- <button id="pack" data-price="30.00" class="btn">Pack of 12</button> --}}
                        </div>
                        <div class="box">
                            <h3 class="price">$ 4.15</h3>
                ...
                <div class="card recovery">
                    ...
                    <div class="content">
                        <div class="buttons">
                            ...
                            {{-- <button id="pack 1" data-price="9" class="btn">Pack of 12</button> --}}
                        </div>
                        <div class="box">
                            <h3 class="price">$ 3</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur
                ...
                <div class="card energy">
                    ...
                    <div class="content">
                        <div class="buttons">
                            ...
                            {{-- <button id="pack 2" data-price="48" class="btn">Pack of 12</button> --}}
                        </div>
                        <div class="box">
                    ...
                    <div class="image">
                        <img src="{{ asset('frontend/img/energy.png') }}" alt="...">
...
<!-- <div id="newsletterModal" class="modal">
    <div class="modal-content">
        ...
        <img src="{{asset('assets/logo.png')}}" alt="" style="width: 80%;margin-bottom: 16px;">
